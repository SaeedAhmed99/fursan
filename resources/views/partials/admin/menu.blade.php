...
<div class="navbar-wrapper">
    ...
    <div class="navbar-content">
                ...
                @if (!empty($userPlan) && $userPlan->hrm == 1)
                    @if (Gate::check('manage employee') || Gate::check('manage setsalary'))
                        <li
                            ...
                            Request::segment(1) == 'employee-contracts' ||
                            Request::segment(1) == 'employee-contracts-assign' ||
                            ...
                            <ul class="dash-submenu">
                                ...
                                {{--<li
                                    class="dash-item  {{ Request::segment(1) == 'employee-contracts' ? 'active dash-trigger' : '' }}   ">
                                    @if ( \Auth::user()->type == 'company')
                                        
                                        <a class="dash-link"
                                            href="{{ route('employee.contracts') }}">{{ __('Contracts') }}</a>
                                    @endif
                                </li>
                                <li
                                    class="dash-item  {{ Request::segment(1) == 'employee-contracts-assign' ? 'active dash-trigger' : '' }}   ">
                                    @if ( \Auth::user()->type == 'Employee')
                                        
                                        <a class="dash-link"
                                            href="{{ route('employee.contracts.assign') }}">{{ __('Contracts Assigned') }}</a>
                                    @endif
                                </li>--}}
                                <li
                                    class="dash-item dash-hasmenu  {{ Request::segment(1) == 'employee-contracts' || Request::segment(1) == 'employee-contracts-assign' ? 'active dash-trigger' : '' }}">
                                    <a class="dash-link" href="#">{{ __('Contract') }}<span
                                            class="dash-arrow"><i data-feather="chevron-right"></i></span></a>
                                    <ul class="dash-submenu">
                                        @if ( \Auth::user()->type == 'company')
                                            <li
                                                class="dash-item {{ request()->is('employee-contracts') ? 'active' : '' }}">
                                                <a class="dash-link"
                                                href="{{ route('employee.contracts') }}">{{ __('Contracts') }}</a>
                                            </li>
                                            <li
                                                class="dash-item {{ request()->is('employee-contracts-all-assign') ? 'active' : '' }}">
                                                <a class="dash-link"
                                                href="{{ route('employee.contracts.all.assign') }}">{{ __('Contracts Assigned') }}</a>
                                            </li>
                                        @endif
                                        @if ( \Auth::user()->type == 'Employee')
                                            <li
                                                class="dash-item {{ request()->is('employee-contracts-assign') ? 'active' : '' }}">
                                                <a class="dash-link"
                                                href="{{ route('employee.contracts.assign') }}">{{ __('Contracts Assigned') }}</a>
                                            </li>
                                        @endif
                                ...
                                @if (Gate::check('manage set salary') || Gate::check('manage pay slip'))
                                    <li
                                        ...
                                        <ul class="dash-submenu">
                                            ...
                                            @endcan
                                            <li class="dash-item {{ request()->is('files.payslip') ? 'active' : '' }}">
                                                <a class="dash-link"
                                                    href="{{ route('files.payslip') }}">{{ __('Payslip File') }}</a>
                                            </li>
                                        </ul>
                                    </li>
                                @endif
        ...
        @if (\Auth::user()->type == 'user')
            <li
                class="dash-item @if(request()->is('profile')) active @endif "  >
                <a class="dash-link" href="{{ route('profile') }}">
                    {{-- <span class="dash-micon">
                        <i class="ti ti-user"></i>
                    </span> --}}
                    <span class="dash-mtext">
            ...
            <li
                class="dash-item @if(request()->is('all-jobs')) active @endif">
                <a class="dash-link" href="{{ route('all.jobs') }}">
                    <span class="dash-mtext">
                        {{ __('Jobs') }}
                    </span>
                </a>
            ...
            <li
                class="dash-item @if(request()->is('all-jobs-apply')) active @endif">
                <a class="dash-link" href="{{ route('all.jobs.apply') }}">
                    <span class="dash-mtext">
                        {{ __('Jobs Apply') }}
                    </span>
                </a>
