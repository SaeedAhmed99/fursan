...
@section('breadcrumb')
    ...
    @if ($user->type == 'user')
        <li class="breadcrumb-item"><a href="{{ url()->previous() }}">{{__('Job Application Details')}}</a></li>
    @else
        <li class="breadcrumb-item"><a href="{{ url()->previous() }}">{{__('Employee')}}</a></li>
    @endif
    <li class="breadcrumb-item">{{__('User')}}</li>
    <li class="breadcrumb-item">{{__('CV / Resume')}}</li>
@endsection
@push('css-page')
    <style>
    ...
    <div class="row">
        <div class="col-xl-3">
            <div class="card sticky-top" style="top:30px">
                <div class="list-group list-group-flush" id="useradd-sidenav">
                    ...
                    @if ($employee != null || $user->type == 'user')
        ...
        <div class="col-xl-9">
            <div id="personal_info" class="card">
                ...
                <div class="card-body">
                    {{Form::model($employeeUser,array('route' => array('update.account'), 'method' => 'post', 'enctype' => "multipart/form-data"))}}
                    @csrf
                    <input type="number" name="employeeUser" value="{{ $employeeUser->id }}" hidden>
                    <div class="row">
                        <div class="col-lg-6 col-sm-6">
                            <div class="form-group">
                                <label class="col-form-label text-dark">{{__('Name')}}</label>
                                <input class="form-control" name="name" type="text" id="name" placeholder="{{ __('Enter Your Name') }}" value="{{ $user->name ?? '' }}" required autocomplete="name">
                            </div>
                        </div>
                        {{-- @if ($employee != null || $user->type == 'user') --}}
                        <div class="col-lg-6 col-sm-6">
                            <div class="form-group">
                                ...
                                <input class="form-control" name="dob" type="date" id="dob" placeholder="{{ __('Enter Date of Birth') }}" value="{{ $user->dob ?? '' }}" required>
                            </div>
                        </div>
                        <div class="col-lg-6 col-sm-6">
                            <div class="form-group">
                                <label class="col-form-label text-dark">{{__('Country of Residence')}}</label>
                                <input class="form-control" name="country_of_residence" type="text" id="country_of_residence" placeholder="{{ __('Enter Country of Residence') }}" value="{{ $user->country_of_residence ?? '' }}" required >
                            </div>
                        </div>
                        <div class="col-lg-6 col-sm-6">
                            <div class="form-group">
                                <label class="col-form-label text-dark">{{__('Nationality')}}</label>
                                <input class="form-control" name="nationality" type="text" id="nationality" placeholder="{{ __('Enter Nationality') }}" value="{{ $user->nationality ?? '' }}" required>
                            </div>
                        </div>
                        <div class="col-lg-6 col-sm-6">
                            <div class="form-group">
                                <label class="col-form-label text-dark">{{__('Address')}}</label>
                                <input class="form-control" name="address" type="text" id="address" placeholder="{{ __('Enter Address') }}" value="{{ $user->address ?? '' }}" required>
                            </div>
                        </div>
                        <div class="col-lg-6 col-sm-6">
                            <div class="form-group">
                                ...
                                {{-- <input class="form-control" name="gender" type="text" id="gender" placeholder="{{ __('Enter Gender') }}" value="{{ $user->employee->gender }}" required> --}}
                            </div>
                        </div>
                        <div class="col-lg-6 col-sm-6">
                            <div class="form-group">
                                <label class="col-form-label text-dark">{{__('Phone')}}</label>
                                <input class="form-control" name="phone" type="text" id="phone" placeholder="{{ __('Enter Phone') }}" value="{{ $user->phone ?? '' }}" required>
                            </div>
                        </div>
                        {{-- @endif --}}
                        <div class="col-lg-6 col-sm-6">
                            <div class="form-group">
                                ...
                                <input class="form-control" name="email" type="email" id="email" placeholder="{{ __('Enter Your Email Address') }}" value="{{ $user->email ?? '' }}" required autocomplete="email">
                            </div>
                        </div>
